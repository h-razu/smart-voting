...
const Error = () => {
    ...
    return (
        <div className='h-screen flex items-center justify-center flex-col gap-8'>
            <h1 className='text-6xl font-bold' style={{ fontFamily: "Redressed" }}>Oops!</h1>
            <p className='text-4xl font-semibold' style={{ fontFamily: "Redressed" }}>Sorry, an unexpected error has occurred.</p>
