...
const Modal = ({ closeModal, successModal, modalData, constituencyData, centerData }) => {
        ...
        <>
            ...
            <div className="modal">
                <div className="modal-box relative">
                    <label htmlFor="add-voter-modal" className="btn btn-sm btn-circle absolute right-2 top-2" onClick={closeModal}>✕</label>
                    ...
                    <div>
                        ...
                        <div className="form-control w-full">
                            ...
                            <select name='constituency' id='constituency-name' required className="select select-bordered w-full mb-1"
                                onChange={e => setOption(e.target.value)}>
                                <option disabled selected>Constituency Name</option>
                                {
                                    constituencyData?.length > 0 ? constituencyData.map((d, index) =>
                                        <option
                                            key={index}
